                ...
                <div className="d-flex flex-column gap-4 text-center">
                  ...
                  <div className="d-flex flex-column gap-2">
                    ...
                    <p className="mb-0">
                      ...
                      <span className="text-primary">MicroAgent AI</span>{" "}
                      because we know there's no room for compromise when it
                      comes to data access and agentic actions. We use a
                      combination of Profile and Role based access control to
                      retrieve agentic actions and data access for MicroAgent.
                    </p>
                  </div>
                </div>
              </div>
